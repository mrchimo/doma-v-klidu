...
insert into public.sitter_profiles (user_id, bio, motivation, animal_experience, accepts_dogs, accepts_cats, accepts_small_animals, overnight_stays, daily_visits, dog_walking, emergency_help, medication_experience, senior_pet_experience, puppy_experience, reactive_dog_experience, multiple_pet_experience, rate_range, availability_notes, available_weekends, available_weekday_evenings, available_mornings, available_short_notice, unavailable_until, reference_contact, video_intro_url, phone_verified, reference_checked, video_intro_reviewed, bio_reviewed, experience_reviewed, risk_reviewed, risk_flags, risk_notes, admin_public_note, admin_private_note, approval_status, is_featured)
values
  ('00000000-0000-0000-0000-000000000201','Klidná sitterka z Letné, zvyklá na byty i starší kočky.','Chci pomáhat lidem cestovat bez stresu.','10 let péče o kočky a menší psy, zkušenost s léky.', true, true, false, true, true, true, false, true, true, false, false, true, '700-1100 Kč / den', 'Víkendy a všední večery.', true, true, false, false, null, 'Jana P., Praha 7', null, true, true, false, true, true, true, array[]::text[], null, 'Profil a reference zkontrolovány administrátorem.', null, 'approved', true),
  ('00000000-0000-0000-0000-000000000202','Spolehlivý sitter pro Vinohrady a okolí, vhodný i na přespání.','Mám rád jasné instrukce a klidný režim zvířat.','Zkušenosti s venčením, reaktivnějšími psy a kontrolou domácnosti.', true, true, false, true, true, true, true, false, false, false, true, true, '800-1300 Kč / den', 'Po domluvě i urgentně.', true, true, true, true, null, 'Klára S., Praha 3', null, true, true, false, true, true, true, array[]::text[], null, 'Ověřený profil se zkušeností s přespáním a citlivějšími psy.', null, 'approved', false),
  ('00000000-0000-0000-0000-000000000203','Pečlivá sitterka v Olomouci.','Hlídání beru jako důvěru, ne jen úkol.','Kočky, drobná zvířata, rostliny a pošta.', false, true, true, false, true, false, false, false, true, false, false, false, '500-800 Kč / den', 'Odpoledne a víkendy.', true, false, false, false, null, null, null, false, false, false, false, true, true, array['missing_reference'], 'Čeká na doplnění reference.', null, 'Čeká na reference.', 'pending_approval', false),
  ('00000000-0000-0000-0000-000000000204','Student ve Zlíně, dostupný na venčení.','Chci získat další reference.','Psi v rodině, základní venčení.', true, false, false, false, true, true, false, false, false, true, false, false, '300-600 Kč / den', 'Všední dny po 16:00.', false, true, false, false, null, null, null, false, false, false, false, false, true, array['short_experience','missing_reference'], 'Zkušenosti jsou stručné, nejdřív ověřit.', null, null, 'pending_approval', false),
  ('00000000-0000-0000-0000-000000000205','Profesionální pečovatelka v Brně.','Specializuji se na náročnější péči.','Senioři, léky, více zvířat, citlivější psi.', true, true, true, true, true, true, true, true, true, false, true, true, '1200-1800 Kč / den', 'Dle kapacity.', false, false, true, true, '2026-06-15', 'Veterinární klinika Brno', null, true, true, false, true, true, true, array['outside_mvp_scope'], 'Profesionální profil mimo první MVP.', null, 'Zamítnuto pro MVP seed kvůli ukázce administrátorského stavu.', 'rejected', false)
